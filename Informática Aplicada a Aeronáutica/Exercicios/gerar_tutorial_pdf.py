...
<head>
<meta charset="UTF-8">
<title>Tutorial Passo a Passo: Formatação de Relatório Técnico no Padrão ABNT (MS Word)</title>
<style>
  @page {
    size: A4;
  ...
  .header-cover {
    background: linear-gradient(135deg, #0f2043 0%, #1a365d 100%);
    color: white;
    padding: 24px 30px;
    border-radius: 8px;
    margin-bottom: 25px;
...
<div class="header-cover">
  <div class="subtitle">FATEC SOROCABA — CURSO SUPERIOR DE TECNOLOGIA EM MANUTENÇÃO DE AERONAVES</div>
  <h1>Guia Prático Ilustrado: Formatação ABNT no Microsoft Word</h1>
  <div class="subtitle">Componente Curricular: INF-117 — Informática Aplicada a Aeronáutica | Prof. André Souza</div>
  <div class="meta">
...
<p>
  Este guia visual passo a passo foi elaborado especialmente para orientar o estudante do curso de <strong>Manutenção de Aeronaves da Fatec Sorocaba</strong> na transformação de um texto técnico bruto em um <strong>Relatório Técnico Profissional no padrão ABNT</strong>, pronto para entrega em disciplinas de engenharia e no Trabalho de Graduação (TG/TCC).
</p>

<div class="callout">
  <strong>Objetivo de Aprendizagem:</strong> Dominar as 8 etapas essenciais de editoração técnica no Microsoft Word (Configuração de Página, Margens ABNT, Estilos de Parágrafo, Quebras de Seção, Numeração de Páginas Desvinculada, Tabelas Técnicas, Figuras com Legendas Oficiais, Sumário Automático e Exportação em PDF/A).
</div>

<!-- ========================================================================= -->
<!-- PASSO 1 -->
<!-- ========================================================================= -->
<h2>1. Configuração da Página e Margens Oficiais da ABNT</h2>
...
<h2>2. Padronização dos Estilos de Parágrafo (Estilo Normal)</h2>
...
<div class="step-box">
  ...
  <ol>
    ...
    <li>Clique em <strong>OK</strong> na janela de Parágrafo e em <strong>OK</strong> na janela Modificar Estilo.</li>
  </ol>
...
<!-- PASSO 3 -->
<!-- ========================================================================= -->
<h2>3. Hierarquia dos Estilos de Título e Painel de Navegação</h2>
...
<div class="step-box">
  ...
  <table>
    <thead>
      <tr>
        <th>Nível de Título</th>
        <th>Estilo no Word</th>
        <th>Fonte / Tamanho</th>
    ...
    <tbody>
      <tr>
        <td><strong>Capítulo Principal</strong> (ex: 1. HISTÓRIA)</td>
        <td><strong>Título 1</strong></td>
        <td>Arial 14 pt</td>
        <td><strong>Negrito, MAIÚSCULAS</strong></td>
        <td>Antes: 12 pt / Depois: 6 pt</td>
      ...
      <tr>
        ...
        <td>Antes: 6 pt / Depois: 6 pt</td>
        <td><code>Ctrl + Alt + 2</code></td>
      </tr>
      <tr>
        <td><strong>Corpo do Relatório</strong></td>
...
<!-- ========================================================================= -->
<div class="page-break"></div>
<h2>4. Criação da Capa e Inserção de Quebras de Seção</h2>
...
<!-- PASSO 5 -->
<!-- ========================================================================= -->
<h2>5. Desvinculação de Cabeçalhos e Numeração ABNT</h2>
...
<!-- ========================================================================= -->
<div class="page-break"></div>
<h2>6. Formatação de Tabelas Técnicas e Legendas Oficiais</h2>
...
<!-- PASSO 7 -->
<!-- ========================================================================= -->
<h2>7. Geração do Sumário Automático e a Tecla F9</h2>
...
<!-- ========================================================================= -->
<div class="page-break"></div>
<h2>8. Exportação Oficial no Padrão PDF/A (ISO 19005)</h2>
...
<!-- ========================================================================= -->
<h2>9. Checklist de Autoavaliação do Aluno</h2>

<p>Antes de enviar seus arquivos no sistema da disciplina, confira cada um dos itens abaixo:</p>
...
<div class="callout">
  <strong>Fatec Sorocaba — CST em Manutenção de Aeronaves</strong><br>
...
html_path = r"c:\projetos\Material\Informática Aplicada a Aeronáutica\Exercicios\Tutorial_Formatacao_ABNT_Word.html"
pdf_path = r"c:\projetos\Material\Informática Aplicada a Aeronáutica\Exercicios\Tutorial_Formatacao_ABNT_Word.pdf"
...
# Run Microsoft Edge Headless to print pixel-perfect PDF
edge_cmd = [
...
if os.path.exists(pdf_path) and os.path.getsize(pdf_path) > 0:
    print(f"PDF Tutorial generated successfully at: {pdf_path} (Size: {os.path.getsize(pdf_path)} bytes)")
else:
