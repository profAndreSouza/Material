...
- Versão responsiva do totem para testes em smartphones.
- Adaptado para 360x640 até 800x1280.
- Link ou QR code para acesso ao simulador web (ex: via Vercel, Netlify).
...
- [ ] Apresentação do projeto (opcional)
