% ==============================================================================
% SLIDES - SEMANA 04: CONTAINERIZAÇÃO DE APLICAÇÕES COM DOCKER (DOCKERFILE & IMAGENS EFICIENTES)
% ==============================================================================

% 1. CAPA
\senaicover
  {Containerização de Aplicações com Docker (Dockerfile & Imagens Eficientes)}
  {Empacotamento de software e padronização de ambientes de execução.}
...
% 3. CONTEÚDO TEÓRICO
\begin{senaiframe}{Teoria • Módulo 1}{Containerização de Aplicações com Docker (Dockerfile & Imagens Eficientes)}
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaibluecard, title={Fundamentos Teóricos}]
        \begin{itemize}
          \item Arquitetura do Docker, imagens vs. contêineres, sintaxe de Dockerfile, multi-stage builds e otimização de camadas.
        \end{itemize}
      \end{tcolorbox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaigreencard, title={Prática \& Laboratório}]
        \begin{itemize}
          \item Escrita de Dockerfile otimizado multi-stage para a aplicação Flask da FactoryHub.
        \end{itemize}
      \end{tcolorbox}
    \end{column}
  \end{columns}
