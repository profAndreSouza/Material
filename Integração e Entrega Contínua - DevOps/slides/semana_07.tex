% ==============================================================================
% SLIDES - SEMANA 07: AUTOMAÇÃO DE TESTES NO PIPELINE DE CI (UNITÁRIOS, INTEGRAÇÃO E COBERTURA)
% ==============================================================================

% 1. CAPA
\senaicover
  {Automação de Testes no Pipeline de CI (Unitários, Integração e Cobertura)}
  {Garantia de qualidade de código automatizada antes do deploy.}
...
% 3. CONTEÚDO TEÓRICO
\begin{senaiframe}{Teoria • Módulo 1}{Automação de Testes no Pipeline de CI (Unitários, Integração e Cobertura)}
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaibluecard, title={Fundamentos Teóricos}]
        \begin{itemize}
          \item Pytest, mocks, testes de integração de API REST, testes de banco de dados e relatórios de cobertura de código (Coverage.py).
        \end{itemize}
      \end{tcolorbox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaigreencard, title={Prática \& Laboratório}]
        \begin{itemize}
          \item Implementação de suíte de testes automatizados integrada à esteira de CI do GitHub Actions.
        \end{itemize}
      \end{tcolorbox}
    \end{column}
  \end{columns}
