% ==============================================================================
% SLIDES - SEMANA 05: ORQUESTRAÇÃO LOCAL DE MICROSERVIÇOS COM DOCKER COMPOSE
% ==============================================================================

% 1. CAPA
\senaicover
  {Orquestração Local de Microserviços com Docker Compose}
  {Gerenciamento de múltiplos contêineres e dependências em ambiente de desenvolvimento.}
...
% 3. CONTEÚDO TEÓRICO
\begin{senaiframe}{Teoria • Módulo 1}{Orquestração Local de Microserviços com Docker Compose}
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaibluecard, title={Fundamentos Teóricos}]
        \begin{itemize}
          \item Arquivo `docker-compose.yml`, volumes persistentes, redes virtuais internas, variáveis de ambiente e dependências de inicialização (`depends_on`).
        \end{itemize}
      \end{tcolorbox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaigreencard, title={Prática \& Laboratório}]
        \begin{itemize}
          \item Criação da orquestração Docker Compose unindo o servidor Flask da FactoryHub e o Broker MQTT Mosquitto.
        \end{itemize}
      \end{tcolorbox}
    \end{column}
  \end{columns}
