...
| :--- | :---: | :---: | :--- |
| **Prova Teórico-Prática 1 (P1)** | **50%** | **27,5%** | Avaliação individual cobrindo os conteúdos da Semana 01 até a Semana 07 (CRISP-DM, estatística descritiva, EDA e séries temporais). |
| **Prova Teórico-Prática 2 (P2)** | **50%** | **27,5%** | Avaliação individual cobrindo os conteúdos das Semanas 10 a 16 (engenharia de recursos, aprendizado de máquina e OEE). |
