% ==============================================================================
% SLIDES - SEMANA 07: ANÁLISE DE SÉRIES TEMPORAIS INDUSTRIAIS (TIME SERIES ANALYSIS)
% ==============================================================================

% 1. CAPA
\senaicover
  {Análise de Séries Temporais Industriais (Time Series Analysis)}
  {Comportamento temporal de sensores de temperatura, pressão e vibração.}
...
% 3. CONTEÚDO TEÓRICO
\begin{senaiframe}{Teoria • Módulo 1}{Análise de Séries Temporais Industriais (Time Series Analysis)}
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaibluecard, title={Fundamentos Teóricos}]
        \begin{itemize}
          \item Tendência, sazonalidade, ruído, decomposição de séries temporais, autocorrelação (ACF/PACF) e médias móveis.
        \end{itemize}
      \end{tcolorbox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaigreencard, title={Prática \& Laboratório}]
        \begin{itemize}
          \item Modelagem de previsão de temperatura da máquina com média móvel exponencial (EWMA).
        \end{itemize}
      \end{tcolorbox}
    \end{column}
  \end{columns}
