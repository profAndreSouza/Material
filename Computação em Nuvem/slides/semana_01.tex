% ==============================================================================
% SLIDES - SEMANA 01: INTRODUÇÃO À COMPUTAÇÃO EM NUVEM NA INDÚSTRIA 4.0 E MODELOS DE SERVIÇO
% ==============================================================================

% 1. CAPA
\senaicover
  {Introdução à Computação em Nuvem na Indústria 4.0 e Modelos de Serviço}
  {Arquitetura de nuvem para sustentação de sistemas de manufatura conectada.}
...
% 3. CONTEÚDO TEÓRICO
\begin{senaiframe}{Teoria • Módulo 1}{Introdução à Computação em Nuvem na Indústria 4.0 e Modelos de Serviço}
  \begin{columns}[t]
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaibluecard, title={Fundamentos Teóricos}]
        \begin{itemize}
          \item Pilares da nuvem, elasticidade, resiliência, modelos IaaS, PaaS, SaaS e nuvens públicas/híbridas.
        \end{itemize}
      \end{tcolorbox}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{tcolorbox}[senaigreencard, title={Prática \& Laboratório}]
        \begin{itemize}
          \item Instalação e configuração da CLI do Google Cloud (gcloud) / AWS CLI.
        \end{itemize}
      \end{tcolorbox}
    \end{column}
  \end{columns}
